...
import CollectionLeftSidebars from './components/collection/collection-left-sidebars';
					...
					<ScrollContext>
						<Switch>
                            ...
                            <Layout>
								...
								<Route path={`${process.env.PUBLIC_URL}/Category/:id`} component={CollectionLeftSidebars}/>
