    ...
    render (){
        ...
        return (
            <div>
                ...
                <section class=" ratio_square light-layout section-b-space">
                    <div class="title2">
                ...
                <section class="ratio_square tools-grey light-layout section-b-space">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <Slider {...Product5} class="product-5 product-m no-arrow">
                ...
                <section class="ratio_asos game-product section-b-space">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <Slider {...Product5} class="product-5 game-product product-m no-arrow">
