                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="cart-info cart-wrap">
                                ...
                                <Link to={`${process.env.PUBLIC_URL}/compare`} title="Compare" onClick={onAddToCompareClicked}  class="hide-for-mob">
                        ...
                        <div class="product-detail">
                            <div>
                                ...
                                <Link to={`${process.env.PUBLIC_URL}/deals/product/${product.id}`}>
                                    <h6>{product.name}</h6>
                                </Link>
                                ...
                                {product.discount > 0 ?  
                                    ...
                                    : 
                                    <h4>{symbol}{product.price.toFixed(2)}</h4> 
                                }
