                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-8 col-md-7 ">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="blog-left">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/details`} >
                                                <img src={`${process.env.PUBLIC_URL}/assets/images/blog/1.jpg`} class="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                ...
                                <div class="row blog-media">
                                    <div class="col-xl-6">
                                        <div class="blog-left">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/details`} ><img src={`${process.env.PUBLIC_URL}/assets/images/blog/2.jpg`} class="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="blog-right">
                                ...
                                <div class="row blog-media">
                                    <div class="col-xl-6">
                                        <div class="blog-left">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/details`} ><img src={`${process.env.PUBLIC_URL}/assets/images/blog/3.jpg`} class="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="blog-right">
                                ...
                                <div class="row blog-media">
                                    <div class="col-xl-6">
                                        <div class="blog-left">
                                            <Link to={`${process.env.PUBLIC_URL}/blog/details`} ><img src={`${process.env.PUBLIC_URL}/assets/images/blog/4.jpg`} class="img-fluid" alt=""/></Link>
                                        </div>
                                    </div>
                                    <div class="col-xl-6">
                                        <div class="blog-right">
