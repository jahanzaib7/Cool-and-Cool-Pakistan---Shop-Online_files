                                            ...
                                            <div class="checkout-details">
                                                ...
                                                {(this.props.settings[country][2].Value > 0?  
                                                    <div class="payment-box row couponbob">
                                                        ...
                                                        <input class="col-md-12 col-sm-12 col-xs-12" type="text" name="Coupoun" value={this.state.Coupoun} onChange={this.setStateFromInput} /> <a type="button" class="btn-solid coupoun mt-3 col-md-2 offset-md-10" style={{borderRadius:6,textAlign:'center'}} onClick={() => this.coupounApply()} >Apply Coupon</a>
                                                        <div class="mt-2">
                                                            <div style={{
